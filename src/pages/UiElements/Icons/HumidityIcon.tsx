...
const HumidityIcon = ({ color = '#000000', size = "24px" }) => {
  return (
    <svg fill={color} width={size} height={size} viewBox="0 0 64 64" version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
      <g id="cloudy_sunny" />
      <g id="bright" />
      <g id="cloudy" />
      <g id="high_rainfall" />
